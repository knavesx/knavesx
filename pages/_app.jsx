...
function MyApp({ Component, pageProps }) {
  ...
  return (<>
    <Head>
        <title>Knaves </title>
        <link rel="shortcut icon" href="https://media.discordapp.net/attachments/1282140026200653825/1282140121214222357/UHPy-0u4S8qGq4s0vmES3g.png?ex=66e43449&is=66e2e2c9&hm=cafc735beaba862daf3d8805374aecfb18bac1ce069c69d329f21ea08bc72491&=&format=webp&quality=lossless&width=671&height=671" ></link>
        ...
        <div className="max-w-screen-lg p-5 w-full md:w-10/12 lg:w-8/12 mx-auto transition-all duration-300">
          <div className="md:flex w-full items-center justify-between">
            ...
            <div className="mt-2 md:mt-0 flex items-center">
              <a href="https://discord.gg/knavesx" target="_blank" rel="noreferrer" className="w-full md:w-auto bg-neutral-700/5 hover:bg-neutral-700/20 px-4 py-2 rounded-md transition-all duration-200">
