...
const items = [
        { icon: 'fab fa-instagram', link: 'https://instagram.com/cannats_1' },
    ...
    { icon: 'fab fa-github', link: 'https://github.com/knavesx' },
  ]
...
const navItems = [
    ...
    { icon: 'fal fa-rss', active: 'fa fa-rss', label: 'knaves', href: 'https://blog.codeshare.me' }
]
